...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	if (wndHandle)
	{
		...
		MessageBox(0, "Unable to create window", "An error occured", MB_OK);
...
HWND InitWindow(HINSTANCE hInstance)
{
	...
	wcex.lpszClassName = "BTH_D3D_DEMO";		// A pointer to a null-terminated string or is an atom. If lpszClassName is a string, it specifies the window class name
	...
	HWND handle = CreateWindow(
		"BTH_D3D_DEMO",						// A null-terminated string or a class atom created by a previous call to the RegisterClass or RegisterClassEx function
		"BTH Direct3D Demo",						// The window name
